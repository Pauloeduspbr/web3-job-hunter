...
**Senior Data Engineer | Cloud & Big Data | Web3 & FinTech Data**

*ATS Match: 100% — Senior Data Engineer @ Consensys*

São Paulo, Brazil — Remote (UTC-3, LATAM) | +55 11 91526-7337 | paulo_eduardosp@yahoo.com.br
...
Senior Data Engineer with 9 years building and operating large-scale data pipelines and platforms for banking, payments, and e-commerce organizations processing millions of daily transactions. Strong in Python and SQL with production experience across cloud data warehouses (Snowflake, BigQuery, Redshift), transformation and orchestration with dbt and Airflow, and big-data processing with Apache Spark, AWS EMR, and S3. Embeds data quality, data governance, and security (PII/LGPD) into every pipeline, deploys infrastructure as code with Terraform, and automates CI/CD. Builder of public open-source blockchain-data projects (Ethereum, Solana, DeFi) — combining enterprise data engineering with hands-on Web3.
...
**Transformation & Orchestration:** dbt, Apache Airflow, ETL/ELT design, CDC, Kafka

**Cloud Warehouses:** Snowflake, BigQuery, Amazon Redshift

**Big Data & Distributed Processing:** Apache Spark, AWS EMR / EMR Serverless, S3, Athena, Trino, Hive
...
**Data Quality & Governance:** data quality frameworks, data catalog (AWS Glue, Unity Catalog), PII/LGPD compliance, HashiCorp Vault, AWS KMS

**Cloud Platforms:** AWS (S3, EMR, Glue, Athena, Redshift, Lambda, Kinesis, Lake Formation, Step Functions, KMS), Azure (Databricks, Data Factory, Synapse), GCP (BigQuery, Dataproc)

**Infrastructure & CI/CD:** Terraform, Docker, Kubernetes, Git, CI/CD

**Web3 / Blockchain Data:** on-chain analytics (Ethereum, Solana), DeFi/NFT metrics, Dune Analytics
...
- Converted complex SQL logic to distributed processing; developed PySpark and SparkSQL on Databricks.
...
- Created QlikSense dashboards connected to Redshift, documented existing ETL processes, optimized queries, and trained business teams.
...
- Planned a NoSQL structure with Cassandra for a credit system; integrated legacy systems via DataStage.

**Bradesco — Data Ingestion Framework**
- Updated ingestion-framework scripts for Hive and HBase tables; developed shell automation and integrated with the IBM IWS scheduler; connected to Teradata for extraction.
...
- Sustained a Hortonworks environment; configured security with Kerberos/Ranger and AD integration; developed Oozie monitoring scripts, built Grafana dashboards, and trained the client team.
...
- Installed and configured 3 Cloudera clusters (Data Lake, M2M, BI); implemented Kerberos with AD as KDC and cross-realm trust; integrated Hive/Impala with BI tools (SAS, QlikView, Alteryx).
- Built a data ingestion framework and monitoring/sustainment scripts and integrated Informatica BDM for ETL — cutting processing time by **50%**. Mentored and led 2 engineers.

**Nextel — Sustainment & ETL**
- Developed ETL ingestion processes, analyzed data with Beeline/Impala, extracted data via Sqoop, gathered requirements, and sustained the production environment.
